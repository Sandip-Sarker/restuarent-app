        ...
        <div class="d-lg-flex d-none">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg">
                    ...
                    <div class="d-flex gap-2 m-2">
                        <a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
                            <img src="{{asset('/')}}admin/assets/images/brand-behance.svg" class="img-3x" alt="Admin Themes" />
                        </a>
                        <a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
                            <img src="{{asset('/')}}admin/assets/images/brand-gatsby.svg" class="img-3x" alt="Admin Themes" />
                        </a>
                        <a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
                            <img src="{{asset('/')}}admin/assets/images/brand-google.svg" class="img-3x" alt="Admin Themes" />
                        </a>
                        <a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
                            <img src="{{asset('/')}}admin/assets/images/brand-bitcoin.svg" class="img-3x" alt="Admin Themes" />
                        </a>
                        <a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
                            <img src="{{asset('/')}}admin/assets/images/brand-dribbble.svg" class="img-3x" alt="Admin Themes" />
                        </a>
                    </div>
                    <!-- Row end -->
                </div>
            ...
            <div class="dropdown border-start">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex py-2 border-bottom">
                            <img src="{{asset('/')}}admin/assets/images/user3.png" class="img-3x me-3 rounded-5" alt="Admin Theme" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex py-2 border-bottom">
                            <img src="{{asset('/')}}admin/assets/images/user1.png" class="img-3x me-3 rounded-5" alt="Admin Theme" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex py-2">
                            <img src="{{asset('/')}}admin/assets/images/user4.png" class="img-3x me-3 rounded-5" alt="Admin Theme" />
                            <div class="m-0">
